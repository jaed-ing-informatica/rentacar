  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">-->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Javier Elgueta</a>
        </div>
      </div>
...
-->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="https://jaed.ing.informaticagmail.com">JAED-Informatica</a>.</strong> Todos los derechos reservados.
  </footer>
  </div>
