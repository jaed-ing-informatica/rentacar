                    ...
                    <div class="card-title">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6 col-md-offset-5">
                                    ...
                                    <input type="text" class="form-control" name="NumeroChasis" id="NumeroChasis" value="{{ isset($vehiculo->NumeroChasis)?$vehiculo->NumeroChasis:old('NumeroChasis') }}">
                                    {!! $errors->first('NumeroChasis','<div class="invalid-feedback">:message</div>') !!}
                                    </div>

                                    <div class="from-group">
                                    <label for="Combustible" class="control-label {{ $errors->has('Combustible')?'is-invalid':'' }}">{{ 'Combustible' }}</label>
                                    <input type="text" class="form-control" name="Combustible" id="Combustible" value="{{ isset($vehiculo->Combustible)?$vehiculo->Combustible:old('Combustible') }}">
