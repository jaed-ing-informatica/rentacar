...
class Invoice{
    ...
    //private $user  = 'root';
    //private $password   = "";
    //private $database  = "sistemarentacar";   
	...
	public function getInvoiceList(){
		...
		$datosFactura['factura_orden']=Factura::paginate(10);
		
		/*$sqlQuery = "
			SELECT * FROM ".$this->invoiceOrderTable." 
			WHERE user_id = '".$_SESSION['userid']."'";
			$invoiceList = $sqlQuery();*/
		return  view('invoice_list',$datosFactura);
	}	
